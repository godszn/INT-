                ...
                <section className="contact-container flex" style={{ padding: '6rem', justifyContent: 'center', width: '100%', gap: '6rem' }}>
                    <section className="contact-widget p-4" style={{ width: '347.98px', backgroundColor: 'white', borderRadius: '1rem', padding: '.5rem' }}>
                        ...
                        <div className="contact-input flex flex-col">
                            <input className='m-4' placeholder='Name' style={{ borderRadius: '.3rem', border: '1px solid #998E8E', width: '316px', margin: '.5rem', padding: '.5rem' }} />
                            <input className='m-4' placeholder='Business Email*' style={{ borderRadius: '.3rem', border: '1px solid #998E8E', width: '316px', margin: '.5rem', padding: '.5rem' }} />
                            <input className='m-4' placeholder='Alternative Email*' style={{ borderRadius: '.3rem', border: '1px solid #998E8E', width: '316px', margin: '.5rem', padding: '.5rem' }} />
                            <input className='m-4' placeholder='+234   |' style={{ borderRadius: '.3rem', border: '1px solid #998E8E', width: '316px', margin: '.5rem', padding: '.5rem' }} />
